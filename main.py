...
def translate_and_summarize(ai_config: dict, text: str, target_lang: str = "ja") -> str:
    ...
    prompt = f"""以下の原文について、{target_lang}で、どのような研究かを理解できるようなタイトルを記述し、次に、課題が何か、その課題をどうやって解決したかとその新規性、limitationと残課題、を専門外の人でもわかるようにまとめてください。雑誌名や発表日は出力しないでください。箇条書きやヘッダは不要[...]
