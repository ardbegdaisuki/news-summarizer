...
def translate_and_summarize(ai_config: dict, text: str, target_lang: str = "ja") -> str:
    ...
    prompt = f"""以下の原文について、{target_lang}で、どのような研究かを理解できるようなタイトルを記述し、次に、本質的な課題が何かを１文で、その課題をどうやって解決したかを１文で、専門外の人でもわかるようにまとめてください。
この研究をMRIに応用あるいは、さらに発展させるとしたら、考えられる研究テーマを1個提案し、１文でまとめてください。雑誌名や発表日は出力しないでください。[...]
